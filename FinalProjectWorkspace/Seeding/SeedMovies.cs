...
namespace FinalProjectWorkspace.Seeding
{
	public static class SeedMovies
	{
		...
		AllMovies.Add(new Movie
		{
			MovieID = 3001,
			Title = "Finding Nemo",
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Animation"),
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Family"),
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Adventure"),
		...
		AllMovies.Add(new Movie
		{
			MovieID = 3018,
			Title = "Pulp Fiction",
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Thriller"),
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Crime"),
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Western"),
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "War"),
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Genre.FirstOrDefault(c => c.GenreName == "Fantasy"),
